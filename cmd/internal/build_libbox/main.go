...
func init() {
	...
	sharedFlags = append(sharedFlags, "-X github.com/inazumav/sing-box/constant.Version="+currentTag+" -s -w -buildid=")
	debugFlags = append(debugFlags, "-X github.com/inazumav/sing-box/constant.Version="+currentTag)
