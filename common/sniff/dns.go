...
func StreamDomainNameQuery(readCtx context.Context, reader io.Reader, sniffdata *ChanSafe[SniffData]) {
	var length uint16
	var data SniffData
...
func DomainNameQuery(ctx context.Context, packet []byte, sniffdata *ChanSafe[SniffData]) {
	var msg mDNS.Msg
	var data SniffData
